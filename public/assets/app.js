...
function buildMenuHtmlForRole(role) {
  ...
  const items = [
    ...
    { kind: "link", label: "Controllo di Gestione: Costi", href: "dashboard-costi.html", roles: ["manager"] },
    { kind: "link", label: "Controllo di Gestione: Riepilogo", href: "dashboard-controllo.html", roles: ["manager"] },
